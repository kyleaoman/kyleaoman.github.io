...
{% include figure.html path="assets/img/martini_banner.png" path_dark="assets/img/martini_banner_dark.png" class="img-fluid rounded" width="65%" href="https://github.com/kyleaoman/martini" %}
